...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lineEdit_val = new QLineEdit(frame_3);
        lineEdit_val->setObjectName(QStringLiteral("lineEdit_val"));
        sizePolicy1.setHeightForWidth(lineEdit_val->sizePolicy().hasHeightForWidth());
        lineEdit_val->setSizePolicy(sizePolicy1);
        lineEdit_val->setAlignment(Qt::AlignCenter);

        gridLayout_18->addWidget(lineEdit_val, 2, 0, 1, 1);
        ...
        sizePolicy6.setHeightForWidth(dateEdit_present->sizePolicy().hasHeightForWidth());
        dateEdit_present->setSizePolicy(sizePolicy6);
        ...
        sizePolicy6.setHeightForWidth(dateEdit_future->sizePolicy().hasHeightForWidth());
        dateEdit_future->setSizePolicy(sizePolicy6);
        ...
        sizePolicy6.setHeightForWidth(pushButton_master->sizePolicy().hasHeightForWidth());
        pushButton_master->setSizePolicy(sizePolicy6);
        ...
        sizePolicy6.setHeightForWidth(pushButton_reg->sizePolicy().hasHeightForWidth());
        pushButton_reg->setSizePolicy(sizePolicy6);
        ...
        sizePolicy6.setHeightForWidth(pushButton_delete->sizePolicy().hasHeightForWidth());
        pushButton_delete->setSizePolicy(sizePolicy6);
        ...
        sizePolicy6.setHeightForWidth(pushButton_allow->sizePolicy().hasHeightForWidth());
        pushButton_allow->setSizePolicy(sizePolicy6);
        ...
        sizePolicy6.setHeightForWidth(pushButton_confirm_2->sizePolicy().hasHeightForWidth());
        pushButton_confirm_2->setSizePolicy(sizePolicy6);
        ...
        gridLayout_17->addWidget(pushButton_19, 7, 0, 1, 1);
        ...
        pushButton_21 = new QPushButton(login);
        ...
        gridLayout_17->addWidget(pushButton_21, 7, 2, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lineEdit_val->setText(QApplication::translate("MainWindow", "1", 0));
        ...
        lineEdit_password->setText(QApplication::translate("MainWindow", "111111", 0));
        ...
        pushButton_19->setText(QApplication::translate("MainWindow", "DEL", 0));
        pushButton_20->setText(QApplication::translate("MainWindow", "0", 0));
        pushButton_21->setText(QApplication::translate("MainWindow", "ENTER", 0));
    } // retranslateUi
