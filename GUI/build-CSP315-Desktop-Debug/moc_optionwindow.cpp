...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_OptionWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 43, 0)
    ...
    "OptionWindow\0on_pushButton_confirm_clicked\0"
    "\0"
};
...
const QMetaObject OptionWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_OptionWindow.data,
      qt_meta_data_OptionWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OptionWindow.stringdata))
